...
void
Logger::log_debug(const char* file, int line, const char* format, ...)
{
  va_list arg_ptr;
...
void
Logger::log_info(const char* file, int line, const char* format, ...)
{
  va_list arg_ptr;
  va_start(arg_ptr, format);
...
void
Logger::log_warn(const char* file, int line, const char* format, ...)
{
  va_list arg_ptr;
  va_start(arg_ptr, format);
...
void
Logger::log_error(const char* file, int line, const char* format, ...)
{
  va_list arg_ptr;
  va_start(arg_ptr, format);
...
void
Logger::log_fatal(const char* file, int line, const char* format, ...)
{
  va_list arg_ptr;
  va_start(arg_ptr, format);
