...
const string &Object::get_class_name() const { return m_className; }

int Object::get_field_count() {
  return Singleton<ClassFactory>::instance()->get_class_field_count(
      m_className);
}
...
ClassField *Object::get_field(const string &fieldName) {
  return Singleton<ClassFactory>::instance()->get_class_field(m_className,
                                                              fieldName);
}
...
void ClassFactory::register_class_field(const string &className,
                                        ...
                                        size_t offset) {
  m_classFields[className].push_back(
      new ClassField(fieldName, fieldType, offset));
}
...
ClassField *ClassFactory::get_class_field(const string &className,
                                          const string &fieldName) {
...
void ClassFactory::register_class_method(const string &className,
...
ClassMethod *ClassFactory::get_class_method(const string &className,
                                            const string &methodName) {
