...
public:
  ...
  int call(const string &methodName, int num);
...
public:
  ...
  // reflect class field
  void register_class_field(const string &className, const string &fieldName,
                            const string &fieldType, size_t offset);
  ...
  void register_class_method(const string &className, const string &methodName,
                             uintptr_t method);
  int get_class_method_count(const string &className);
  ClassMethod *get_class_method(const string &className, int pos);
  ClassMethod *get_class_method(const string &className,
...
template <typename T> void Object::get(const string &fieldName, T &value) {
